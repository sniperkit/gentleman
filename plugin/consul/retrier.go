...
// DefaultRetrier stores the default retry strategy used by the p.
...
type Retrier struct {
	...
	// Context stores the HTTP current gentleman c.
	Context *c.Context
...
// NewRetrier creates a default retrier for the given Consul client and c.
func NewRetrier(c *Consul, ctx *c.Context) *Retrier {
